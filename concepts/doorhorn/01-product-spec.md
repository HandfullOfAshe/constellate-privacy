...
- *Docked start (the intended setup).* The phone sits docked on the counter overnight with the app in the foreground; at T-12:30 the app plays the station ID itself and rolls into the track. Nobody touches anything.
